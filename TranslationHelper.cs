...
namespace Ultima
{
    ...
    public class TranslationHelper
    {
        ...
        private const string AnalyticsLangPath = "~/App_Plugins/Ultima/Config/Lang/";
        ...
        public static void AddTranslations()
        {
            ...
            LogHelper.Info<InstallHelpers>(string.Format("{0} Ultima Plugin language files to be merged into Umbraco language files", analyticsFiles.Count()));
            ...
            LogHelper.Info<InstallHelpers>(string.Format("{0} Umbraco language files that match up with our Ultima language files", existingLangs.Count()));
            ...
            foreach (var lang in existingLangs)
            {
                ...
                {
                    LogHelper.Error<InstallHelpers>("Failed to add Ultima localization values to language file", ex);
                }
        ...
        {
            var analyticsFiles = GetAnalyticsLanguageFiles();
            LogHelper.Info<InstallHelpers>(string.Format("{0} Ultima Plugin language files to be removed into Umbraco language files", analyticsFiles.Count()));
